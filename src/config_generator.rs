...
"#,
    ...
    fn generate_kitty_colors(&self, color_scheme: &ColorScheme) -> Result<String> {
        ...
        color_lines.push("# ═══════════════════════════════════════════════════════════════════".to_string());
        color_lines.push(String::new());
        color_lines.push("# Background and foreground".to_string());
        ...
        color_lines.push(String::new());
        color_lines.push("# Tab colors".to_string());
        ...
        color_lines.push(String::new());
        color_lines.push(String::new());
        color_lines.push("# Window borders".to_string());
